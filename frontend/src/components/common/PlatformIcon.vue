<template>
  ...
  <!-- Copilot logo (simple shield/agent mark) -->
  <svg v-else-if="platform === 'copilot'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2 4 5v6c0 5.25 3.4 9.82 8 11 4.6-1.18 8-5.75 8-11V5l-8-3Zm0 4a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 12c-2.67 0-5.03-1.33-6.47-3.36A5.97 5.97 0 0 1 12 11c2.76 0 5.18 1.5 6.47 3.64A7.96 7.96 0 0 1 12 18Z" />
  </svg>
  ...
  <!-- Kiro logo (spinning top / K shape) -->
  <svg v-else-if="platform === 'kiro'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2L3 7v10l9 5 9-5V7l-9-5zm0 2.18L18.82 7.5 12 10.82 5.18 7.5 12 4.18zM5 9.08l6 3.33v7.41l-6-3.33V9.08zm8 10.74v-7.41l6-3.33v7.41l-6 3.33z" />
  </svg>
