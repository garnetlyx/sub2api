...
export type GroupPlatform = 'anthropic' | 'openai' | 'copilot' | 'gemini' | 'antigravity' | 'kiro'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'copilot' | 'gemini' | 'antigravity' | 'kiro'
